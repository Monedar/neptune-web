...
export default function App() {
  return (
    // Components should be wrapped by Provider component which init and provides context data for them
    // usually this should be done once at the top level component
